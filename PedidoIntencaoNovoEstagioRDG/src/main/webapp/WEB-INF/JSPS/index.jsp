...
<body>
    <form action="Controller" method="post" onsubmit="return validarEGerarIdentificador()">
       	<h1>
		  Pedido de Intenção de Estágio
		  <span style="display: block; font-size: 12px; color: gray;"> Portão de acesso aos dados em linhas  - Sem camada Service</span>
		</h1>
	    ...
	    function validarEGerarIdentificador() {
	        // Recupera o identificador do usuário se já existir
	        ...
	        if (identificadorSalvo) {
	            ...
	            if (confirmar) {
	                // Mantém o identificador existente
        ...
        <div class="checkbox-container">
            ...
            <label for="iraUlt">IRA dos dois últimos períodos</label>
        </div>
